...
def create_pollen_glossary(pcv_graph: Graph) -> None:
    pollen_intensity_URI = add_Property(
        pcv_graph,
        "pollen_intensity",
        {
            "en": "Pollen intensity",
            "fr": "Intensité pollinique"
        },
        {
            "en": "How pollen-charged the air of the area is.",
            "fr": "À quel point l'air de la région est chargé en pollen."
        },
        pcv['Properties']
    )
    pollen_type_URI = add_Property(
        pcv_graph,
        "pollen_intensity",
        {
            "en": "Pollen type",
        ...
        {
            "en": "The pollen type, often the vegetal species it is produced by.",
            "fr": "Le type de pollen, souvent l'espèce végétale qui l'a produit."
        },
        pcv['Properties']
    )
    add_FeatureKind(
        ...
        {
            "en": "This element of interest is pollen-related, e.g. an area describing pollen intensity and type in the air.",
            "fr": "Cet élément d'intérêt a trait au pollen, e.g. une région décrivant l'intensité et le type de pollen dans l'air."
        },
        properties_uris = [pollen_intensity_URI, pollen_type_URI]
    )
    

def create_meteo_glossary(pcv_graph: Graph) -> None:
    temperature_URI = add_Property(
        pcv_graph,
        "temperature",
        {
            "en": "Temperature",
        ...
        {
            "en": "The air temperature of the area, typically expressed in degrees Celsius or Fahrenheit.",
            "fr": "La température de l'air de la région, généralement exprimée en degrés Celsius ou Fahrenheit."
        },
        pcv['Properties']
    )

    humidity_URI = add_Property(
        pcv_graph,
        "humidity",
        {
            "en": "Humidity",
        ...
        {
            "en": "The relative humidity of the air in the area, expressed as a percentage.",
            "fr": "L'humidité relative de l'air de la région, exprimée en pourcentage."
        },
        pcv['Properties']
    )

    wind_speed_URI = add_Property(
        pcv_graph,
        "wind_speed",
        {
            "en": "Wind speed",
        ...
        {
            "en": "The speed of the wind in the area, typically expressed in km/h or m/s.",
            "fr": "La vitesse du vent dans la région, généralement exprimée en km/h ou m/s."
        },
        pcv['Properties']
    )

    wind_direction_URI = add_Property(
        pcv_graph,
        "wind_direction",
        {
            "en": "Wind direction",
        ...
        {
            "en": "The direction from which the wind is blowing in the area, typically expressed in degrees or cardinal points.",
            "fr": "La direction d'où souffle le vent dans la région, généralement exprimée en degrés ou en points cardinaux."
        },
        pcv['Properties']
    )

    precipitation_URI = add_Property(
        pcv_graph,
        "precipitation",
        {
            "en": "Precipitation",
        ...
        {
            "en": "The amount of precipitation in the area, typically expressed in mm.",
            "fr": "La quantité de précipitations dans la région, généralement exprimée en mm."
        },
        pcv['Properties']
    )

    cloud_cover_URI = add_Property(
        pcv_graph,
        "cloud_cover",
        {
            "en": "Cloud cover",
        ...
        {
            "en": "The fraction of the sky covered by clouds in the area, typically expressed as a percentage or in oktas.",
            "fr": "La fraction du ciel couverte par les nuages dans la région, généralement exprimée en pourcentage ou en octas."
        },
        pcv['Properties']
    )

    pressure_URI = add_Property(
        pcv_graph,
        "pressure",
        {
        ...
        {
            "en": "The atmospheric pressure in the area, typically expressed in hPa or mbar.",
            "fr": "La pression atmosphérique dans la région, généralement exprimée en hPa ou mbar."
        },
        pcv['Properties']
    )

    weather_condition_URI = add_Property(
        pcv_graph,
        "weather_condition",
        {
        ...
        {
            "en": "The general weather condition of the area, e.g. sunny, cloudy, rainy, snowy.",
            "fr": "La condition météorologique générale de la région, e.g. ensoleillé, nuageux, pluvieux, neigeux."
        },
        pcv['Properties']
    )
    ...
    add_FeatureKind(
        ...
        {
            "en": "This element of interest is meteorology-related, e.g. an area describing weather conditions such as temperature, humidity, wind and precipitation.",
            "fr": "Cet élément d'intérêt a trait à la météorologie, e.g. une région décrivant les conditions météorologiques telles que la température, l'humidité, le vent et les précipitations."
        },
        properties_uris=[
            temperature_URI,
            humidity_URI,
...
def main():
    ...
    create_pollen_glossary(pcv_graph)
    create_meteo_glossary(pcv_graph)
